import { MiniGameModel } from "./MiniGameModel.ts";
import type { Target } from "./MiniGameModel.ts";
import { MiniGameView } from "./MiniGameView.ts";
                ...
                if (placed) {
                    ...
                    if(this.model.allPlaced()){
                        if(playerDataManager.getLevel() == "level 2"){
                            ...
                            this.screenSwitcher.switchToScreen("level3");
                        }
                    }
